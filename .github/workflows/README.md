...
This workflow runs when changes are pushed to the main branch under the Databricks/notebooks/modules path. It:
...
This workflow deploys the Databricks bundle located at `Databricks/bundles/daily_capitals_weather` when changes are pushed to the main branch in that bundle's directory. It supports automated delivery of the daily_capitals_weather bundle.
