resource "databricks_notebook" "bronze_openaq" {
  ...
  content_base64 = filebase64("${path.module}/../notebooks/aq_bronze_autoloader.py")
...
resource "databricks_notebook" "silver_openaq" {
  ...
  content_base64 = filebase64("${path.module}/../notebooks/aq_silver_clean.py")
...
resource "databricks_notebook" "gold_openaq" {
  ...
  content_base64 = filebase64("${path.module}/../notebooks/aq_gold_daily_summary.py")
